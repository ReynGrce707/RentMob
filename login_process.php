...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if ($user['lvl'] == 'admin') {
            header('Location: admin/adm.php'); // Arahkan ke dashboard admin
        } elseif ($user['lvl'] == 'petugas') {
            header('Location: petugas/pet.php'); // Arahkan ke dashboard petugas
        } else {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            header('Location: user/user.php'); // Arahkan ke dashboard user
        } else {
