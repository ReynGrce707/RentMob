                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>RentMob Login</h3>
                            </a>
                        ...
                        <p class="text-center mb-0">Gaada akun? registrasi akun disini cuy! <a href="regis.php">Register</a></p>
                    </div>
