        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="hist.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Laporan</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">History rental</h6>
                            <div class="table-responsive">
                            <a href="generate_laporan.php" target="_blank" class="btn btn-primary m-2">
                    <i class="fa fa-print me-2"></i> Generate Laporan ke PDF
                </a>
                                <table class="table">
                                <?php
include "koneksi.php";
        ...
        <?php if ($result->num_rows > 0) { ?>
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td><?php echo $row['mobil_yang_dipinjam']; ?></td>
