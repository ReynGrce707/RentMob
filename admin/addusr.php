...
<form class="forms-sample" method="post">    
   ...
   <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="alm" class="form-control" id="alm" >
    </div>
...
if (isset($_POST['submit'])) {
  ...
  if ($stmt->affected_rows > 0) {
      echo "<script>alert('Sukses menambahkan User.'); location.href='usr.php';</script>";
  } else {
      echo "<script>alert('Gagal menambahkan.'); location.href='usr.php';</script>";
  }
