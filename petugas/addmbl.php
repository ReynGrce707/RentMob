...
<form class="forms-sample" method="post">    
    ...
    <div class="mb-3">
        ...
        <input type="text" name="brand" class="form-control" id="brnd" >
    </div>
    <div class="mb-3">
        <label for="typ">Tipe Mobil</label>
        <input type="text" name="type" class="form-control" id="typ" >
    </div>
    <div class="mb-3">
        <label for="tt">Rilis Mobil</label>
        <input type="date" name="tt" class="form-control" id="tt" placeholder="" >
    </div>
    <div class="mb-3">
        <label for="hrg">Harga Rental / hari</label>
        <input type="text" name="hrg" class="form-control" id="hrg" >
    </div>
    <div class="mb-3">
        <label for="img">Foto Mobil</label>
        <input type="file" name="img" class="form-control form-control-sm bg-dark" id="img">
    </div>
    <input type="hidden" name="Role" value="tersedia">
...
if (isset($_POST['submit'])) {
  ...
  // Siapkan statement
  $stmt = $koneksi->prepare("INSERT INTO tb_mobil VALUES (?, ?, ?, ?, ?, ?, ?)");
  
  // Bind parameter dengan tipe data yang sesuai
  $stmt->bind_param("sssssss", $nopol, $brand, $type, $tt, $hrg, $img, $Role);
  
  // Eksekusi statement
  $stmt->execute();

  if ($stmt->affected_rows > 0) {
      echo "<script>alert('Sukses menambahkan.'); location.href='pet.php';</script>";
  } else {
      echo "<script>alert('Gagal menambahkan.'); location.href='pet.php';</script>";
  }
