        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="data_rental.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Data Rental</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                if ($row["status"] == 'booking') {
                                    echo "<td><a href='approve.php?id=" . $row["id_transaksi"] . "' class='btn btn-primary rounded-pill m-2'>Setujui Perentalan</a></td>";
                                } elseif ($row["status"] == 'approve') {
                                    echo "<td><button class='btn btn-secondary' disabled>Menunggu Mobil Diambil</button></td>";
                                } elseif ($row["status"] == 'ambil') {
                                    echo "<td><a href='kembali.php?id=" . $row["id_transaksi"] . "' class='btn btn-primary rounded-pill m-2'>Pengembalian dan Pembayaran</a></td>";
                                } elseif ($row["status"] == 'kembali') {
                                    echo "<td><button class='btn btn-secondary' disabled>transaksi Selesai</button></td>";
                                }
