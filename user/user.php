                    ...
                    <div class="h-100 bg-secondary rounded p-4">
                        ...
                        <div>
                         ...
                         <strong>Nomor Polisi:</strong> <?php echo $row["nopol"]; ?><br>
                                ...
                                $status = $row["status"];    
                                if ($status == 'tersedia') {
                                    // Jika mobil tersedia, tampilkan tombol aktif
                                    echo "<td><button class='btn btn-primary rounded-pill m-2' onclick=\"window.location.href='rental.php?nopol=" . $row["nopol"] . "'\">Rental Mobil</button></td>";
                                } else {                         
                                    // Jika mobil tidak tersedia, tampilkan tombol dinonaktifkan
                                    echo "<td><button class='btn btn-secondary rounded-pill m-2' disabled>Mobil Tidak Tersedia</button></td>";
                                }
                                ?>
                        </div>
                    </div>
